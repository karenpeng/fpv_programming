...
//module.exports = {
exports.initTargetandObstacles = function () {
  ...
  var obs = exports.initObstacles(tarX, tarY, tarZ);
...
exports.initObstacles = function (tarX, tarY, tarZ) {
    var obsInfo = [];
    ...
    for (j = 0; j < 24; j++) {
      var x, y, z;
      do {
        x = 375 - Math.round(myMath.getSimilarValue(oriX, 0, 16)) * 50;
        z = 375 - Math.round(myMath.getSimilarValue(oriZ, 0, 16)) * 50;
